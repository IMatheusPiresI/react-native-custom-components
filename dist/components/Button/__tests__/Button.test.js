...
describe('Buttom Component Tests UI', () => {
    ...
    it('should be render default bgColor buttom', () => {
        (0, react_native_1.render)(react_1.default.createElement(__1.Button, { font: "bold", title: "Entrar", titleColor: "#fff", height: 40 }));
        const cardTitle = react_native_1.screen.getByTestId('button');
        expect(cardTitle.props.style.backgroundColor).toBe('#000fff');
    });
    it('should be render default text color', () => {
        (0, react_native_1.render)(react_1.default.createElement(__1.Button, { font: "bold", title: "Entrar", height: 40 }));
        const cardTitle = react_native_1.screen.getByTestId('typograph');
