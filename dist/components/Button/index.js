...
const Button = (_a) => {
    ...
    const styles = react_native_1.StyleSheet.create({
        container: Object.assign({ width: width || '100%', height: height ? (0, getButtonSize_1.getButtonSize)(height) : 'auto', backgroundColor: rest.disabled ? disabledColor !== null && disabledColor !== void 0 ? disabledColor : '#B0AFAF' : bgColor, alignItems: 'center', justifyContent: 'center', paddingVertical: paddingVertical || 6, paddingHorizontal: paddingHorizontal || 6, padding: padding, shadowColor: shadowColor || '#000000', borderRadius: radius || 12 }, (0, getShadow_1.getShadow)(shadow, shadowColor)),
        title: {
            fontSize: fontSize || 12,
            color: titleColor,
            fontFamily: (0, getFontFamily_1.getFontFamily)(font),
        },
    });
